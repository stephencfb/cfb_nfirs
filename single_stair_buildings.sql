...
AND plutos.bldgarea / plutos.numfloors <= 2000) -- Average floor size is at most 2,000 sq. ft. (the code section states that no upper floor can be more than 2,000 sq. ft., but this is as close as we can get, and in any case it's mostly redundant with the above line, and required or even allowed stepbacks in these districts are minimal)
